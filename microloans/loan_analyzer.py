...
number_of_loans=len(loan_costs) ###counting elements of list
...
print(remaining_months,f"month(s) remaining on this loan")
...
# YOUR CODE HERE!
discount_rate=.2
fair_value= future_value/(1+discount_rate/12)**loan.get("remaining_months")
print(f"Fair value of the loan is $",round(fair_value,2))
...
# # YOUR CODE HERE!
if fair_value < loan.get("loan_price"): ###starting with the non-inclusive condistion to avoid "greater or equal"
    print(f"The loan is too expensive relative to its fair value")
else :
    print(f"The loan is worth at least the cost to buy it at its $",loan.get("loan_price"),f"price")
...
def calculate_present_value (future_value,remaining_months,discount_rate): ###Defining function and its parameters
...
present_value= calculate_present_value(new_loan.get("future_value"),new_loan.get("remaining_months"),0.2) ###creating variable by calling function
